Shader "VRC_MINE/WorldOptimizator"
{
    Properties
    {
        ...
        _ClearChunksTex ("Clear Chunks", 2D) = "white" {}
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            int block(int3 pos)
            {
                ...
                int2 ch = ((pos.xz>>4)&63)*int2(256,128);
                pos.xz&=15;
                pos.x+=pos.z*16;
            ...
            uint4 frag(v2f i) : SV_Target
            {
                ...
                if(uv.y<4)
                {
                    ...
                    if(((pos.x>>4)!=(_ChunkX&63)&&(((pos.x+1023)&1023)>>4)!=(_ChunkX&63))||pos.z>>5!=(_ChunkY&63)/2)discard;
                ...
                else if(uv.y<8)
                {
                    ...
                    if(((pos.z>>4)!=(_ChunkY&63)&&(((pos.z+1023)&1023)>>4)!=(_ChunkY&63))||pos.x>>5!=(_ChunkX&63)/2)discard;
                    uint4 mm = uint4(32,0,32,0);
                    for(int y=0;y<32;y++)
                    {
                        for(int x=0;x<32;x++)
                ...
                else
                {
                    ...
                    if(pos.x>>5!=(_ChunkX&63)/2||pos.z>>5!=(_ChunkY&63)/2)discard;
                    uint4 mm = uint4(32,0,32,0);
                    for(int z=0;z<32;z++)
                    {
                        for(int x=0;x<32;x++)
